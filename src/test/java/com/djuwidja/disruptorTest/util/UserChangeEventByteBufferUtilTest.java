...
public class UserChangeEventByteBufferUtilTest {
	...
	public void testUserNameChangeUtil() throws UserChangeEventException {
		...
		try {
			UserChangeEventByteBufferUtil.writeByteBuffer(bb, 1000000, null);
		}
		...
		UserChangeEventByteBufferUtil.writeByteBuffer(bb, 1000000, "01234567890123456789012345678901234567890123456789"); // success case
		
		isExceptionThrown = false;
		try {
			UserChangeEventByteBufferUtil.writeByteBuffer(bb, 1000000, "012345678901234567890123456789012345678901234567891");
		}
